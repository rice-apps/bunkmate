                ...
                <div className="profile-resume-content">
                    {allUsers.filter(user => user.email == user_email).map(user => 
                        <React.Fragment>
                            ...
                            <div className="profile-body">
                                <div className="profile-body-col" id="profile-body-col-left">
                                    <ProfileSection section_name="Personal" user={user} currUser = {props.userData} editable = {false} />
                                    <ProfileSection section_name="Preferences" user={user} currUser = {props.userData} editable = {false}/>
                                </div>
                                <div className="profile-body-col" id="profile-body-col-right">
                                    <ProfileSection section_name="Housing" user={user} currUser = {props.userData} editable = {false}/>
                                </div>
                            </div>
                            <div className="profile-footer">
                                <ProfileSection section_name="Additional Comments" user={user} currUser = {props.userData} editable = {false}/>
                            </div>
                        </React.Fragment>)
                    }
                </div>
